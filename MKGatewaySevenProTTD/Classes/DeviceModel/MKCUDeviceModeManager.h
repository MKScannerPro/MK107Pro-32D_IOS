...
@protocol MKCUDeviceModeManagerDataProtocol <NSObject>
...
@interface MKCUDeviceModeManager : NSObject

+ (MKCUDeviceModeManager *)shared;
...
- (void)addDeviceModel:(id <MKCUDeviceModeManagerDataProtocol>)protocol;
