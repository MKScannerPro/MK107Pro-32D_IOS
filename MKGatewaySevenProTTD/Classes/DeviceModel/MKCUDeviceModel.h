...
typedef NS_ENUM(NSInteger, MKCUDeviceModelState) {
    MKCUDeviceModelStateOffline,
    MKCUDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKCUDeviceModelOfflineNotification;

@protocol MKCUDeviceModelDelegate <NSObject>
...
@interface MKCUDeviceModel : NSObject<MKCUDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKCUDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKCUDeviceModelDelegate>delegate;
