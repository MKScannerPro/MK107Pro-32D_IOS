...
extern NSString *const mk_cu_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_cu_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_cu_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKCUOperation;

@interface MKCUCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_cu_centralManagerScanDelegate>delegate;

@property (nonatomic, weak)id <mk_cu_centralManagerScanWifiDelegate>wifiDelegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_cu_centralConnectStatus connectStatus;
