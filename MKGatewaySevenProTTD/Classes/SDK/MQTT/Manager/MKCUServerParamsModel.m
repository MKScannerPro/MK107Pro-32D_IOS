...
static NSString *const fileName = @"MKCUServerParams.txt";

@interface MKCUServerParamsModel ()
...
@implementation MKCUServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCUServerParamsProtocol>)protocol {
