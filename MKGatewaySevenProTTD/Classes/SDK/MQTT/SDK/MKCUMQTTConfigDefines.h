...
typedef NS_ENUM(NSInteger, mk_cu_keyResetType) {
    mk_cu_keyResetType_powerOnOneMin,     //Press in 1 min after powered
    mk_cu_keyResetType_pressAnyTime,      //Press any time
};
...
typedef NS_ENUM(NSInteger, mk_cu_filterRelationship) {
    ...
    mk_cu_filterRelationship_advNameAndRawDataAndMac,
    mk_cu_filterRelationship_advNameOrRawData,
    mk_cu_filterRelationship_advNameAndRawMac,
};

typedef NS_ENUM(NSInteger, mk_cu_filterByTLM) {
    mk_cu_filterByTLM_nonEncrypted,        //Non-encrypted type TLM
    mk_cu_filterByTLM_encrypted,           //Encryption type TLM
    mk_cu_filterByTLM_all,                //Filter all Eddystone_TLM data
};

typedef NS_ENUM(NSInteger, mk_cu_filterByOther) {
    mk_cu_filterByOther_A,                 //Filter by A condition.
    mk_cu_filterByOther_AB,                //Filter by A & B condition.
    mk_cu_filterByOther_AOrB,              //Filter by A | B condition.
    mk_cu_filterByOther_ABC,               //Filter by A & B & C condition.
    mk_cu_filterByOther_ABOrC,             //Filter by (A & B) | C condition.
    mk_cu_filterByOther_AOrBOrC,           //Filter by A | B | C condition.
};

typedef NS_ENUM(NSInteger, mk_cu_duplicateDataFilter) {
    mk_cu_duplicateDataFilter_none,
    mk_cu_duplicateDataFilter_mac,
    mk_cu_duplicateDataFilter_macAndDataType,
...
@protocol mk_cu_BLEFilterRawDataProtocol <NSObject>
...
@protocol mk_cu_BLEFilterBXPButtonProtocol <NSObject>
...
@protocol mk_cu_BLEFilterPirProtocol <NSObject>
...
@protocol mk_cu_mqttModifyWifiProtocol <NSObject>
...
@protocol mk_cu_mqttModifyWifiEapCertProtocol <NSObject>
...
@protocol mk_cu_mqttModifyNetworkProtocol <NSObject>
...
@protocol mk_cu_modifyMqttServerProtocol <NSObject>
...
@protocol mk_cu_modifyMqttServerCertsProtocol <NSObject>
...
@protocol cu_advertiseBeaconProtocol <NSObject>
