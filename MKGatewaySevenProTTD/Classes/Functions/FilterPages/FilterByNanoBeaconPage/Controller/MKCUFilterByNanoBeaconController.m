//
//  MKCUFilterByNanoBeaconController.m
...
@interface MKCUFilterByNanoBeaconController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCUFilterByNanoBeaconModel *dataModel;

@end

@implementation MKCUFilterByNanoBeaconController

- (void)dealloc {
    NSLog(@"MKCUFilterByNanoBeaconController销毁");
}
...
- (MKCUFilterByNanoBeaconModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUFilterByNanoBeaconModel alloc] init];
    }
    return _dataModel;
}
