...
@interface MKCUUploadDataOptionModel ()
...
@implementation MKCUUploadDataOptionModel
...
- (BOOL)readUploadDataOption {
    ...
    [MKCUMQTTInterface cu_readUploadDataOptionWithMacAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
