//
//  MKCUFilterByRawDataController.m
...
@interface MKCUFilterByRawDataController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCUFilterByRawDataModel *dataModel;

@end

@implementation MKCUFilterByRawDataController

- (void)dealloc {
    NSLog(@"MKCUFilterByRawDataController销毁");
}
...
- (MKCUFilterByRawDataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUFilterByRawDataModel alloc] init];
    }
    return _dataModel;
}
