...
@interface MKCUFilterByRawDataV2Model ()
...
@implementation MKCUFilterByRawDataV2Model
...
- (BOOL)readFilterByRawData {
    ...
    [MKCUMQTTInterface cu_readFilterByRawDataStatusWithMacAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
