...
@interface MKCUBleDeviceInfoModel ()
...
@implementation MKCUBleDeviceInfoModel
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKCUInterface cu_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
