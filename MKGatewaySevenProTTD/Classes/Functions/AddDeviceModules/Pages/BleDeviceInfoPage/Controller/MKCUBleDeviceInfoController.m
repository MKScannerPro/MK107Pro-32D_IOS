...
@interface MKCUBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCUBleDeviceInfoModel *dataModel;

@end

@implementation MKCUBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCUBleDeviceInfoController销毁");
...
- (MKCUBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
