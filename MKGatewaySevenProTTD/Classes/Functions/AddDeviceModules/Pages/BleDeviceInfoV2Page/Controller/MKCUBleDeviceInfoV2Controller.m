//
//  MKCUBleDeviceInfoV2Controller.m
...
@interface MKCUBleDeviceInfoV2Controller ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCUBleDeviceInfoV2Model *dataModel;

@end

@implementation MKCUBleDeviceInfoV2Controller

- (void)dealloc {
    NSLog(@"MKCUBleDeviceInfoV2Controller销毁");
...
- (MKCUBleDeviceInfoV2Model *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUBleDeviceInfoV2Model alloc] init];
    }
    return _dataModel;
}
