...
@interface MKCUBleDeviceInfoV2Model ()
...
@implementation MKCUBleDeviceInfoV2Model
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKCUInterface cu_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKCUInterface cu_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBleFirmware {
    __block BOOL success = NO;
    [MKCUInterface cu_readBLEFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKCUInterface cu_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKCUInterface cu_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKCUInterface cu_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readWifiFirmware {
    __block BOOL success = NO;
    [MKCUInterface cu_readWifiFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
