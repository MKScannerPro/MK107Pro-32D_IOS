...
@interface MKCUBleAdvBeaconV2Model ()
...
@implementation MKCUBleAdvBeaconV2Model
...
- (BOOL)readAdvStatus {
    ...
    [MKCUInterface cu_readAdvertiseBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvStatus {
    __block BOOL success = NO;
    [MKCUInterface cu_configAdvertiseBeaconStatus:self.advertise sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMajor {
    __block BOOL success = NO;
    [MKCUInterface cu_readBeaconMajorWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMajor {
    __block BOOL success = NO;
    [MKCUInterface cu_configBeaconMajor:[self.major integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMinor {
    __block BOOL success = NO;
    [MKCUInterface cu_readBeaconMinorWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMinor {
    __block BOOL success = NO;
    [MKCUInterface cu_configBeaconMinor:[self.minor integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUUID {
    __block BOOL success = NO;
    [MKCUInterface cu_readBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUUID {
    __block BOOL success = NO;
    [MKCUInterface cu_configBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readInterval {
    __block BOOL success = NO;
    [MKCUInterface cu_readBeaconAdvIntervalWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configInterval {
    __block BOOL success = NO;
    [MKCUInterface cu_configAdvInterval:[self.advInterval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTxPower {
    __block BOOL success = NO;
    [MKCUInterface cu_readBeaconTxPowerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTxPower {
    __block BOOL success = NO;
    [MKCUInterface cu_configTxPower:self.txPower sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRssi1m {
    __block BOOL success = NO;
    [MKCUInterface cu_readBeaconRssiWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRssi1m {
    __block BOOL success = NO;
    [MKCUInterface cu_configBeaconRssi:self.rssi1m sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readConnectable {
    __block BOOL success = NO;
    [MKCUInterface cu_readConnectableWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configConnectable {
    __block BOOL success = NO;
    [MKCUInterface cu_configConnectable:self.connectable sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
