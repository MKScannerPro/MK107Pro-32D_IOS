//
//  MKCUDeviceParamsListController.m
...
@interface MKCUDeviceParamsListController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKCUDeviceParamsListController

- (void)dealloc {
    NSLog(@"MKCUDeviceParamsListController销毁");
...
- (void)viewDidLoad {
    ...
    [MKCUDeviceMQTTParamsModel shared].deviceModel.deviceType = self.deviceType;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1 && indexPath.row == 2) {
        //Advertise iBeacon
        MKCUBleAdvBeaconController *vc = [[MKCUBleAdvBeaconController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 1 && indexPath.row == 3) {
        //Device Information
        MKCUBleDeviceInfoController *vc = [[MKCUBleDeviceInfoController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
}
