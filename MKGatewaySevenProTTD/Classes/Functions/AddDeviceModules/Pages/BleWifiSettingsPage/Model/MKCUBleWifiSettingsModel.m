...
@interface MKCUBleWifiSettingsModel ()
...
@implementation MKCUBleWifiSettingsModel
...
- (BOOL)readSecurityType {
    ...
    [MKCUInterface cu_readWIFISecurityWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSecurityType {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFISecurity:self.security sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiSSID {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFISSIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiSSID {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFISSID:self.ssid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiPassword {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFIPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiPassword {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIPassword:self.wifiPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPType {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFIEAPTypeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPType {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIEAPType:self.eapType sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPUsername {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFIEAPUsernameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPUsername {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIEAPUsername:self.eapUserName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPPassword {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFIEAPPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPPassword {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIEAPPassword:self.eapPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPDomainID {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFIEAPDomainIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPDomainID {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIEAPDomainID:self.domainID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readVerifyServer {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFIVerifyServerStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configVerifyServer {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIVerifyServerStatus:self.verifyServer sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKCUInterface cu_configWIFICAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKCUInterface cu_configWIFIClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKCUInterface cu_configWIFIClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiDHCPStatus {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFIDHCPStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiDHCPStatus {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIDHCPStatus:self.wifi_dhcp sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiIpAddress {
    __block BOOL success = NO;
    [MKCUInterface cu_readWIFINetworkIpInfosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiIpAddress {
    __block BOOL success = NO;
    [MKCUInterface cu_configWIFIIpAddress:self.wifi_ip
                                     mask:self.wifi_mask
