//
//  MKCUConnectSuccessController.m
...
@interface MKCUConnectSuccessController ()
...
@implementation MKCUConnectSuccessController

- (void)dealloc {
    NSLog(@"MKCUConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKCUDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cu_addNewDeviceSuccessNotification"
                                                            object:nil
