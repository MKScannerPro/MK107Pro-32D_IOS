//
//  MKCUConnectedDeviceWriteAlertView.m
...
@interface MKCUConnectedDeviceWriteAlertView ()
...
@implementation MKCUConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKCUConnectedDeviceWriteAlertView销毁");
}
