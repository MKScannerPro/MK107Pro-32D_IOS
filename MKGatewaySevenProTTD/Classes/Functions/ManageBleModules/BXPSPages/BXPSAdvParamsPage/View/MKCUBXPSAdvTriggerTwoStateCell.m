//
//  MKCUBXPSAdvTriggerTwoStateCell.m
...
@implementation MKCUBXPSAdvTriggerTwoStateCellModel
...
@interface MKCUBXPSAdvTriggerTwoStateCell ()
...
@implementation MKCUBXPSAdvTriggerTwoStateCell

+ (MKCUBXPSAdvTriggerTwoStateCell *)initCellWithTableView:(UITableView *)tableView {
    MKCUBXPSAdvTriggerTwoStateCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCUBXPSAdvTriggerTwoStateCellIdenty"];
    if (!cell) {
        cell = [[MKCUBXPSAdvTriggerTwoStateCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCUBXPSAdvTriggerTwoStateCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cu_BXPSAdvTriggerTwoStateCell_setPressed:beforeInterval:beforeTxPower:afterInterval:afterTxPower:)]) {
        [self.delegate cu_BXPSAdvTriggerTwoStateCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKCUBXPSAdvTriggerTwoStateCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCUBXPSAdvTriggerTwoStateCellModel.class]) {
        return;
    }
...
- (NSString *)getSlotTypeString:(MKCUBXPSAdvTriggerTwoStateCellSlotType)slotType {
    if (slotType == MKCUBXPSAdvTriggerTwoStateCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKCUBXPSAdvTriggerTwoStateCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKCUBXPSAdvTriggerTwoStateCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKCUBXPSAdvTriggerTwoStateCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKCUBXPSAdvTriggerTwoStateCellSlotTypeTHInfo) {
        return @"T&H info";
    }
    if (slotType == MKCUBXPSAdvTriggerTwoStateCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
