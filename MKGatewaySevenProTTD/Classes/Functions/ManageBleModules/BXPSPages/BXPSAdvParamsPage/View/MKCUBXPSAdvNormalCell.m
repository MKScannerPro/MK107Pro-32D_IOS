...
@implementation MKCUBXPSAdvNormalCellModel

- (CGFloat)fetchCellHeight {
    if (self.slotType == MKCUBXPSAdvNormalCellSlotTypeNoData) {
        return 44.f;
    }
    return 150.f;
}
...
@interface MKCUBXPSAdvNormalCell ()
...
@implementation MKCUBXPSAdvNormalCell

+ (MKCUBXPSAdvNormalCell *)initCellWithTableView:(UITableView *)tableView {
    MKCUBXPSAdvNormalCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCUBXPSAdvNormalCellIdenty"];
    if (!cell) {
        cell = [[MKCUBXPSAdvNormalCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCUBXPSAdvNormalCellIdenty"];
    }
    return cell;
}
...
- (void)layoutSubviews {
    ...
    if (self.dataModel.slotType == MKCUBXPSAdvNormalCellSlotTypeNoData) {
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cu_BXPSAdvNormalCell_setPressed:interval:txPower:)]) {
        [self.delegate cu_BXPSAdvNormalCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKCUBXPSAdvNormalCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCUBXPSAdvNormalCellModel.class]) {
        return;
    }
    ...
    if (_dataModel.slotType == MKCUBXPSAdvNormalCellSlotTypeNoData) {
...
- (NSString *)getSlotTypeString:(MKCUBXPSAdvNormalCellSlotType)slotType {
    if (slotType == MKCUBXPSAdvNormalCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKCUBXPSAdvNormalCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKCUBXPSAdvNormalCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKCUBXPSAdvNormalCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKCUBXPSAdvNormalCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
    if (slotType == MKCUBXPSAdvNormalCellSlotTypeTHInfo) {
        return @"T&H info";
    }
