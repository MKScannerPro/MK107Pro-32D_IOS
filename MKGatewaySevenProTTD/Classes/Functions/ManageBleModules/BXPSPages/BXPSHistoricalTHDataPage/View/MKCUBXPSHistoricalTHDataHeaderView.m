//
//  MKCUBXPSHistoricalTHDataHeaderView.m
...
@interface MKCUBXPSHistoricalTHDataHeaderView ()
...
@implementation MKCUBXPSHistoricalTHDataHeaderView
...
- (void)syncButtonPressed {
    if ([self.delegate respondsToSelector:@selector(cu_BXPSHistoricalHTDataHeaderView_syncButtonPressed:)]) {
        [self.delegate cu_BXPSHistoricalHTDataHeaderView_syncButtonPressed:!self.syncButton.selected];
    }
}

- (void)deleteButtonPressed {
    if ([self.delegate respondsToSelector:@selector(cu_BXPSHistoricalHTDataHeaderView_deleteButtonPressed)]) {
        [self.delegate cu_BXPSHistoricalHTDataHeaderView_deleteButtonPressed];
    }
}

- (void)exportButtonPressed {
    if ([self.delegate respondsToSelector:@selector(cu_BXPSHistoricalHTDataHeaderView_exportButtonPressed)]) {
        [self.delegate cu_BXPSHistoricalHTDataHeaderView_exportButtonPressed];
    }
}
...
- (UIImageView *)synIcon {
    if (!_synIcon) {
        ...
        _synIcon.image = LOADICON(@"MKGatewaySevenProTTD", @"MKCUBXPSHistoricalTHDataHeaderView", @"cu_threeAxisAcceLoadingIcon.png");
    }
    return _synIcon;
}
...
- (UIButton *)exportButton {
    if (!_exportButton) {
        ...
        [_exportButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUBXPSHistoricalTHDataHeaderView", @"cu_slotExportEnableIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)deleteButton {
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUBXPSHistoricalTHDataHeaderView", @"cu_slotExportDeleteIcon.png") forState:UIControlStateNormal];
