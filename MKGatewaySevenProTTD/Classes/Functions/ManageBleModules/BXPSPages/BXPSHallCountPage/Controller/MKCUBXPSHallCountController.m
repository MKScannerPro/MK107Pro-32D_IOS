...
@interface MKCUBXPSHallCountController ()<UITableViewDelegate,
...
@implementation MKCUBXPSHallCountController

- (void)dealloc {
    NSLog(@"MKCUBXPSHallCountController销毁");
}
...
- (void)cu_pressEventCountCell_clearButtonPressed:(NSInteger)index {
    ...
    [MKCUMQTTInterface cu_clearBXPSHallCountWithBleMacAddress:self.bleMac macAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (void)readDatasFromDevice {
    ...
    [MKCUMQTTInterface cu_readBXPSHallCountWithBleMacAddress:self.bleMac macAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
