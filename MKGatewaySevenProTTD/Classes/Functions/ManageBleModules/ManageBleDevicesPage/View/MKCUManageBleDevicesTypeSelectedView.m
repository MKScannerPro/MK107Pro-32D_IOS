//
//  MKCUManageBleDevicesTypeSelectedView.m
...
@interface MKCUManageBleDevicesTypeSelectedView ()<UIGestureRecognizerDelegate,
UITableViewDelegate,
UITableViewDataSource,
MKCUManageBleDevicesTypeSelectedCellDelegate>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, copy)void (^selectedBlock)(MKCUManageBleDevicesTypeSelectedViewType selectedType);

@property (nonatomic, assign)MKCUManageBleDevicesTypeSelectedViewType selectedType;

@end

@implementation MKCUManageBleDevicesTypeSelectedView

- (void)dealloc{
    NSLog(@"MKCUManageBleDevicesTypeSelectedView销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKCUManageBleDevicesTypeSelectedCell *cell = [MKCUManageBleDevicesTypeSelectedCell initCellWithTableView:tableView];
...
#pragma mark - MKCUManageBleDevicesTypeSelectedCellDelegate
- (void)cu_manageBleDevicesTypeSelectedCell_selected:(BOOL)selected index:(NSInteger)index {
    self.selectedType = index;
    for (NSInteger i = 0; i < self.dataList.count; i ++) {
        MKCUManageBleDevicesTypeSelectedCellModel *cellModel = self.dataList[i];
...
+ (void)showWithType:(MKCUManageBleDevicesTypeSelectedViewType)type
    ...
    MKCUManageBleDevicesTypeSelectedView *view = [[MKCUManageBleDevicesTypeSelectedView alloc] init];
...
- (void)loadSectionDatas {
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel1 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel1.index = 0;
    cellModel1.selected = (self.selectedType == 0);
    cellModel1.msg = @"BXP-B-D";
    [self.dataList addObject:cellModel1];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel2 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel2.index = 1;
    cellModel2.selected = (self.selectedType == 1);
    cellModel2.msg = @"BXP-B-CR";
    [self.dataList addObject:cellModel2];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel3 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel3.index = 2;
    cellModel3.selected = (self.selectedType == 2);
    cellModel3.msg = @"BXP-C";
    [self.dataList addObject:cellModel3];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel4 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel4.index = 3;
    cellModel4.selected = (self.selectedType == 3);
    cellModel4.msg = @"BXP-D";
    [self.dataList addObject:cellModel4];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel5 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel5.index = 4;
    cellModel5.selected = (self.selectedType == 4);
    cellModel5.msg = @"BXP-T";
    [self.dataList addObject:cellModel5];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel6 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel6.index = 5;
    cellModel6.selected = (self.selectedType == 5);
    cellModel6.msg = @"BXP-S";
    [self.dataList addObject:cellModel6];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel7 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel7.index = 6;
    cellModel7.selected = (self.selectedType == 6);
    cellModel7.msg = @"MK PIR";
    [self.dataList addObject:cellModel7];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel8 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel8.index = 7;
    cellModel8.selected = (self.selectedType == 7);
    cellModel8.msg = @"MK TOF";
    [self.dataList addObject:cellModel8];
    
    MKCUManageBleDevicesTypeSelectedCellModel *cellModel9 = [[MKCUManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel9.index = 8;
