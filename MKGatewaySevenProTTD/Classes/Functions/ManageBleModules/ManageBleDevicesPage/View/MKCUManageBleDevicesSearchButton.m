//
//  MKCUManageBleDevicesSearchButton.m
...
@implementation MKCUManageBleDevicesSearchButtonModel
@end

@interface MKCUManageBleDevicesSearchButton ()
...
@implementation MKCUManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(cu_scanSearchButtonClearMethod)]) {
        [self.delegate cu_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(cu_scanSearchButtonMethod)]) {
        [self.delegate cu_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKCUManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCUManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKGatewaySevenProTTD", @"MKCUManageBleDevicesSearchButton", @"cu_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUManageBleDevicesSearchButton", @"cu_clearButtonIcon.png") forState:UIControlStateNormal];
