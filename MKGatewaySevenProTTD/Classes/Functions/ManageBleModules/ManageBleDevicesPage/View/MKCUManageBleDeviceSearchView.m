//
//  MKCUManageBleDeviceSearchView.m
...
@interface MKCUManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCUManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCUManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCUManageBleDeviceSearchView *view = [[MKCUManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKGatewaySevenProTTD", @"MKCUManageBleDeviceSearchView", @"cu_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKGatewaySevenProTTD", @"MKCUManageBleDeviceSearchView", @"cu_wifiGraySignalIcon.png");
    }
