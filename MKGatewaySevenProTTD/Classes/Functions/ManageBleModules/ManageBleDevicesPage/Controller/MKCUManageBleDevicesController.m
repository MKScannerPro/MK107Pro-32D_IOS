//
//  MKCUManageBleDevicesController.m
...
@interface MKCUManageBleDevicesController ()<UITableViewDelegate,
...
@implementation MKCUManageBleDevicesController

- (void)dealloc {
    NSLog(@"MKCUManageBleDevicesController销毁");
