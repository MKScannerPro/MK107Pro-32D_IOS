...
@interface MKCUBXPButtonAdvParamsModel ()
...
@implementation MKCUBXPButtonAdvParamsModel
...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKCUMQTTInterface cu_bxpBtnReadAdvParamsWithBleMac:bleMac macAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
