...
@implementation MKCUAddDeviceView
...
- (UIImageView *)centerIcon{
    if (!_centerIcon) {
        ...
        _centerIcon.image = LOADICON(@"MKGatewaySevenProTTD", @"MKCUAddDeviceView", @"cu_deviceList_centerIcon.png");
    }
    return _centerIcon;
}
