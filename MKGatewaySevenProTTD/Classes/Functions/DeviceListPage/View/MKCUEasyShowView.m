...
@implementation MKCUEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKGatewaySevenProTTD", @"MKCUEasyShowView", @"cu_refreshIcon.png");
    }
    return _refreshIcon;
}
