...
@implementation MKCUMqttServerLwtViewModel
@end

@interface MKCUMqttServerLwtView ()
...
@implementation MKCUMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKGatewaySevenProTTD", @"MKCUMqttServerLwtView", @"cu_switchSelectedIcon.png") : LOADICON(@"MKGatewaySevenProTTD", @"MKCUMqttServerLwtView", @"cu_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKGatewaySevenProTTD", @"MKCUMqttServerLwtView", @"cu_switchSelectedIcon.png") : LOADICON(@"MKGatewaySevenProTTD", @"MKCUMqttServerLwtView", @"cu_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKCUMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCUMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUMqttServerLwtView", @"cu_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUMqttServerLwtView", @"cu_switchUnselectedIcon.png") forState:UIControlStateNormal];
