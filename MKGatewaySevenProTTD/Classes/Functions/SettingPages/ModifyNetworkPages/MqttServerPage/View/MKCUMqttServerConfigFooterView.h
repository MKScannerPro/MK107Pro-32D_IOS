//
//  MKCUMqttServerConfigFooterView.h
...
@interface MKCUMqttServerConfigFooterViewModel : NSObject
...
@protocol MKCUMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKCUMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKCUMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCUMqttServerConfigFooterViewDelegate>delegate;
