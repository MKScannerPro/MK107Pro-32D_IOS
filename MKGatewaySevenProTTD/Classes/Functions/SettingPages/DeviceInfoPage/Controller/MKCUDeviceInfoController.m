...
@interface MKCUDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCUDeviceInfoModel *dataModel;

@end

@implementation MKCUDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCUDeviceInfoController销毁");
}
...
- (MKCUDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
