...
@implementation MKCUDeviceInfoModel
...
- (BOOL)readDeviceInfo {
    ...
    [MKCUMQTTInterface cu_readDeviceInfoWithMacAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
