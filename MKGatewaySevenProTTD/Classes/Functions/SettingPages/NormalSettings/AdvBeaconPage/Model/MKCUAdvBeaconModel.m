...
@interface MKCUAdvBeaconParamsModel : NSObject<cu_advertiseBeaconProtocol>
...
@implementation MKCUAdvBeaconParamsModel
@end


@interface MKCUAdvBeaconModel ()
...
@implementation MKCUAdvBeaconModel
...
- (BOOL)configAdvBeaconDatas {
    ...
    MKCUAdvBeaconParamsModel *dataModel = [[MKCUAdvBeaconParamsModel alloc] init];
    ...
    [MKCUMQTTInterface cu_configAdvertiseBeaconParams:dataModel macAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
