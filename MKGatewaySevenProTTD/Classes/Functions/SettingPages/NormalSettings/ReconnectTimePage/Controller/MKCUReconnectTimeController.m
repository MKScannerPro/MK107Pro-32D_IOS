...
@interface MKCUReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCUReconnectTimeModel *dataModel;

@end

@implementation MKCUReconnectTimeController

- (void)dealloc {
    NSLog(@"MKCUReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUReconnectTimeController", @"cu_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCUReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
