...
@interface MKCUCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCUCommunicateModel *dataModel;

@end

@implementation MKCUCommunicateController

- (void)dealloc {
    NSLog(@"MKCUCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUCommunicateController", @"cu_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCUCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUCommunicateModel alloc] init];
    }
    return _dataModel;
}
