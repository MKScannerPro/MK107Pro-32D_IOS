...
@interface MKCUDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCUDataReportModel *dataModel;

@end

@implementation MKCUDataReportController

- (void)dealloc {
    NSLog(@"MKCUDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUDataReportController", @"cu_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCUDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUDataReportModel alloc] init];
    }
    return _dataModel;
}
