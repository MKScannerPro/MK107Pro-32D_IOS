...
@interface MKCUAdvBeaconParamsV2Model : NSObject<cu_advertiseBeaconV2Protocol>
...
@implementation MKCUAdvBeaconParamsV2Model
@end

@interface MKCUAdvBeaconV2Model ()
...
@implementation MKCUAdvBeaconV2Model
...
- (BOOL)readAdvBeaconDatas {
    ...
    [MKCUMQTTInterface cu_readAdvertiseBeaconParamsWithMacAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvBeaconDatas {
    ...
    MKCUAdvBeaconParamsV2Model *dataModel = [[MKCUAdvBeaconParamsV2Model alloc] init];
    ...
    [MKCUMQTTInterface cu_configV2AdvertiseBeaconParams:dataModel macAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
