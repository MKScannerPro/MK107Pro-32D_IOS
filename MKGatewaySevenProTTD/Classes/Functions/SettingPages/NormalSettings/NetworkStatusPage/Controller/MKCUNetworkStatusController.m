...
@interface MKCUNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCUNetworkStatusModel *dataModel;

@end

@implementation MKCUNetworkStatusController

- (void)dealloc {
    NSLog(@"MKCUNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUNetworkStatusController", @"cu_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCUNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCUNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
