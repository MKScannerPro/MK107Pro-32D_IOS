...
@implementation MKCUSettingModel
...
- (BOOL)readOutputSwitch {
    ...
    [MKCUMQTTInterface cu_readOutputSwitchWithMacAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readOutputControlByButton {
    __block BOOL success = NO;
    [MKCUMQTTInterface cu_readOutputControlByButtonWithMacAddress:[MKCUDeviceModeManager shared].macAddress topic:[MKCUDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
