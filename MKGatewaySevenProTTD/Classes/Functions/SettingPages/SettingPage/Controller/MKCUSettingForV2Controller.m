...
@interface MKCUSettingForV2Controller ()<UITableViewDelegate,
...
@implementation MKCUSettingForV2Controller

- (void)dealloc {
    NSLog(@"MKCUSettingForV2Controller销毁");
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && indexPath.row == 4) {
        ...
        MKCUAdvBeaconV2Controller *vc = [[MKCUAdvBeaconV2Controller alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewaySevenProTTD", @"MKCUSettingForV2Controller", @"cu_editIcon.png") forState:UIControlStateNormal];
