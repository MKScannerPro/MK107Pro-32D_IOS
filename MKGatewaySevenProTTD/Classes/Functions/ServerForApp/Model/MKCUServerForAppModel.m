...
@implementation MKCUServerForAppModel
...
- (void)updateValue:(MKCUServerForAppModel *)model {
    if (!model || ![model isKindOfClass:MKCUServerForAppModel.class]) {
        return;
    }
...
- (void)loadServerParams {
    ...
    self.host = [MKCUMQTTDataManager shared].serverParams.host;
    self.port = [MKCUMQTTDataManager shared].serverParams.port;
    self.clientID = [MKCUMQTTDataManager shared].serverParams.clientID;
    self.subscribeTopic = [MKCUMQTTDataManager shared].serverParams.subscribeTopic;
    self.publishTopic = [MKCUMQTTDataManager shared].serverParams.publishTopic;
    self.cleanSession = [MKCUMQTTDataManager shared].serverParams.cleanSession;
    
    self.qos = [MKCUMQTTDataManager shared].serverParams.qos;
    self.keepAlive = [MKCUMQTTDataManager shared].serverParams.keepAlive;
    self.userName = [MKCUMQTTDataManager shared].serverParams.userName;
    self.password = [MKCUMQTTDataManager shared].serverParams.password;
    self.sslIsOn = [MKCUMQTTDataManager shared].serverParams.sslIsOn;
    self.certificate = [MKCUMQTTDataManager shared].serverParams.certificate;
    self.caFileName = [MKCUMQTTDataManager shared].serverParams.caFileName;
    self.clientFileName = [MKCUMQTTDataManager shared].serverParams.clientFileName;
}
