...
@interface MKCUImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCUImportServerController

- (void)dealloc {
    NSLog(@"MKCUImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(cu_selectedServerParams:)]) {
        [self.delegate cu_selectedServerParams:model.leftMsg];
    }
