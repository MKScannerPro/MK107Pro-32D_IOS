...
@interface MKCUAdvTriggerTwoStateCellModel : NSObject
...
@protocol MKCUAdvTriggerTwoStateCellDelegate <NSObject>
...
@interface MKCUAdvTriggerTwoStateCell : MKBaseCell

@property (nonatomic, weak)id <MKCUAdvTriggerTwoStateCellDelegate>delegate;

@property (nonatomic, strong)MKCUAdvTriggerTwoStateCellModel *dataModel;
