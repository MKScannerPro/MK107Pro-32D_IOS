...
@implementation MKCUAlertViewModel
@end

@interface MKCUAlertView ()
...
@implementation MKCUAlertView

- (void)dealloc {
    NSLog(@"MKCUAlertView销毁");
}
...
- (void)showWithModel:(MKCUAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKCUAlertViewModel.class]) {
        return;
    }
