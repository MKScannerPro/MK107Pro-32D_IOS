...
@implementation MKCURemoteReminderCellModel
@end

@interface MKCURemoteReminderCell ()
...
@implementation MKCURemoteReminderCell

+ (MKCURemoteReminderCell *)initCellWithTableView:(UITableView *)tableView {
    MKCURemoteReminderCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCURemoteReminderCellIdenty"];
    if (!cell) {
        cell = [[MKCURemoteReminderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCURemoteReminderCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKCURemoteReminderCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCURemoteReminderCellModel.class]) {
        return;
    }
