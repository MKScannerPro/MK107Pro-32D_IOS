...
@implementation MKCUAdvNormalCellModel
@end

@interface MKCUAdvNormalCell ()
...
@implementation MKCUAdvNormalCell

+ (MKCUAdvNormalCell *)initCellWithTableView:(UITableView *)tableView {
    MKCUAdvNormalCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCUAdvNormalCellIdenty"];
    if (!cell) {
        cell = [[MKCUAdvNormalCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCUAdvNormalCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cu_advNormalCell_setPressed:interval:txPower:)]) {
...
#pragma mark - setter
- (void)setDataModel:(MKCUAdvNormalCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCUAdvNormalCellModel.class]) {
        return;
    }
