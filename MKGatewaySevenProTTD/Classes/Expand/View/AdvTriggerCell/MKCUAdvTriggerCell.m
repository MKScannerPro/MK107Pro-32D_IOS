...
@implementation MKCUAdvTriggerCellModel
@end

@interface MKCUAdvTriggerCell ()
...
@implementation MKCUAdvTriggerCell

+ (MKCUAdvTriggerCell *)initCellWithTableView:(UITableView *)tableView {
    MKCUAdvTriggerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCUAdvTriggerCellIdenty"];
    if (!cell) {
        cell = [[MKCUAdvTriggerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCUAdvTriggerCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(cu_advTriggerCell_setPressed:interval:txPower:)]) {
        [self.delegate cu_advTriggerCell_setPressed:self.dataModel.index
...
#pragma mark - setter
- (void)setDataModel:(MKCUAdvTriggerCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCUAdvTriggerCellModel.class]) {
        return;
    }
