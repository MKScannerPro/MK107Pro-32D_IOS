...
static MKCUUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKCUUserLoginManager ()
...
+ (MKCUUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKCUUserLoginManager new];
        }
    });
    return loginManager;
}
